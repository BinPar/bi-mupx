...
exports.deploy = function (bundlePath, env, config) {
	...
	deployAndVerify(taskList, appName, env.PORT, deployCheckWaitTime, !!config.nextjs, config.mupxNodeVersion);
...
function deployAndVerify(taskList, appName, port, deployCheckWaitTime, isNextJS, mupxNodeVersion) {
	// deploying
	if(isNextJS) {
